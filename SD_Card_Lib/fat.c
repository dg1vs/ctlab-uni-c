 ...
 */
uintptr_t fat_clear_cluster_callback(uint8_t* buffer __attribute__((unused)), offset_t offset __attribute__((unused)), void* p __attribute__((unused)))
{
    return 16;
}
#endif
 ...
 */
uint8_t fat_get_fs_free_16_callback(uint8_t* buffer, offset_t offset __attribute__((unused)), void* p)
{
 ...
 */
uint8_t fat_get_fs_free_32_callback(uint8_t* buffer, offset_t offset __attribute__((unused)), void* p)
{
    struct fat_usage_count_callback_arg* count_arg = (struct fat_usage_count_callback_arg*) p;
    uintptr_t buffer_size = count_arg->buffer_size;
