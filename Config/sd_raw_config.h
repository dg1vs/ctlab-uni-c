...
#ifndef _SD_RAW_CONFIG_H_
#define _SD_RAW_CONFIG_H_
 ...
 */
#define SD_RAW_WRITE_BUFFERING 0 // if 1 consider sync in main job() !!!!!!!!!
...
/* Docu_HW_Init */
#define configure_pin_available() DDRA &= ~(1 << DDA3)
#define get_pin_available() (PINA & (1 << PINA3))
